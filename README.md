...
**To check more about our approach, please follow this document: [DOCUMENTATION.pdf](./DOCUMENTATION.pdf)**
...
* **Semantic Enrichment:** Utilized the Gemma Multimodal Inference model to generate rich semantic descriptions by feeding it both the original image and OCR text. We extracted three features: `text_meaning`, `combined_meaning`, and `context_analysis`.
